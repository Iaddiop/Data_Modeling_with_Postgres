...
def process_song_file(cur, filepath):
    ...
    artist_data = df[['artist_id', 'artist_name', 'artist_location', 'artist_latitude', 'artist_longitude']].loc[0].tolist()
...
def process_log_file(cur, filepath):
    ...
    # load user table
    user_df = df[['sessionId', 'firstName', 'lastName', 'gender', 'level']]
