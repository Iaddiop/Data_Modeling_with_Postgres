...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id serial, start_time timestamp, user_id int, level varchar, song_id int, artist_id varchar, session_id int, location varchar, user_agent varchar)""")
...
song_table_create = ("""
CREATE TABLE IF NOT EXISTS songs (song_id int, title varchar, artist_id varchar, year int, duration float)
""")
